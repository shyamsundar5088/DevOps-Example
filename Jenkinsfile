node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u syam@4088key -p syam@4088" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag  5c1c23f29187   syam4088/myapplication" //must change your name and tag no
        sh "docker push   syam4088/myapplication"
  }
}
